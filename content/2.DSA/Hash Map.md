...
2. **[Contains Duplicate](https://leetcode.com/problems/contains-duplicate/) (LC #217)**
    - **Concepts:** HashMap, HashSet
    - **Asked in:** Google, Facebook, Apple
3. **[Valid Anagram](https://leetcode.com/problems/valid-anagram/) (LC #242)**
    - **Concepts:** HashMap, Frequency Count
    - **Asked in:** Google, Amazon
4. **[Intersection of Two Arrays](https://leetcode.com/problems/intersection-of-two-arrays/) (LC #349)**
    - **Concepts:** HashSet, HashMap
    - **Asked in:** Apple, Uber, Google
5. **[Majority Element](https://leetcode.com/problems/majority-element/) (LC #169)**
...
2. **[Longest Substring Without Repeating Characters](https://leetcode.com/problems/longest-substring-without-repeating-characters/) (LC #3)**
    
    - **Concepts:** HashMap, Sliding Window
    - **Asked in:** Amazon, Facebook, Netflix
3. **[Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) (LC #560)**
    
    - **Concepts:** HashMap, Prefix Sum
    - **Asked in:** Google, Microsoft, Uber
4. **[4Sum II](https://leetcode.com/problems/4sum-ii/) (LC #454)**
    
    - **Concepts:** HashMap, Two-Pass Calculation
    - **Asked in:** Google, Bloomberg
5. **[Word Pattern](https://leetcode.com/problems/word-pattern/) (LC #290)**
    
    - **Concepts:** HashMap, Bijective Mapping
    - **Asked in:** Google, Uber
6. **[Isomorphic Strings](https://leetcode.com/problems/isomorphic-strings/) (LC #205)**
...
1. **[Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) (LC #76)**
    
    - **Concepts:** HashMap, Sliding Window
    - **Asked in:** Google, Microsoft, Facebook
2. **[Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/) (LC #128)**
    
    - **Concepts:** HashMap, Union-Find
    - **Asked in:** Google, Amazon, Facebook
3. **[Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/) (LC #30)**
    
    - **Concepts:** HashMap, Sliding Window
    - **Asked in:** Google, Microsoft
4. **[Palindrome Pairs](https://leetcode.com/problems/palindrome-pairs/) (LC #336)**
    
    - **Concepts:** HashMap, Trie
    - **Asked in:** Google, Bloomberg
5. **[Alien Dictionary (Topological Sorting)](https://leetcode.com/problems/alien-dictionary/) (LC #269 - Premium)**
...
1. **Master HashMap Basics**
    
    - Key-value storage
    - Hash collisions
    - O(1) lookup and insertion
2. **Understand Common HashMap Techniques**
...
3. **Practice Real-World Interview Problems**

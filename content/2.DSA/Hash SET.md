...
8. **[Subarray Sum Equals K](https://leetcode.com/problems/subarray-sum-equals-k/) (LC #560)**
    
    - **Concepts:** HashMap, Prefix Sum
    - **Asked in:** Google, Microsoft, Uber
9. **[4Sum II](https://leetcode.com/problems/4sum-ii/) (LC #454)**
    
    - **Concepts:** HashMap, Two-Pass Calculation
    - **Asked in:** Google, Bloomberg
10. **[Word Pattern](https://leetcode.com/problems/word-pattern/) (LC #290)**
    
    - **Concepts:** HashMap, Bijective Mapping
    - **Asked in:** Google, Uber
11. **[Isomorphic Strings](https://leetcode.com/problems/isomorphic-strings/) (LC #205)**
...
1. **[Minimum Window Substring](https://leetcode.com/problems/minimum-window-substring/) (LC #76)**
    ...
    - **Concepts:** HashMap, Sliding Window
    - **Asked in:** Google, Microsoft, Facebook
13. **[Longest Consecutive Sequence](https://leetcode.com/problems/longest-consecutive-sequence/) (LC #128)**
    
    - **Concepts:** HashMap, Union-Find
    - **Asked in:** Google, Amazon, Facebook
14. **[Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/) (LC #30)**
    
    - **Concepts:** HashMap, Sliding Window
    - **Asked in:** Google, Microsoft
15. **[Palindrome Pairs](https://leetcode.com/problems/palindrome-pairs/) (LC #336)**
    
    - **Concepts:** HashMap, Trie
    - **Asked in:** Google, Bloomberg
16. **[Alien Dictionary (Topological Sorting)](https://leetcode.com/problems/alien-dictionary/) (LC #269 - Premium)**
